                                ...
                                <div>
                                    ...
                                    <div className="my-10">
                                        <div className="w-3/4 mx-auto relative flex justify-between items-center">
                                            ...
                                            <Link to="/Login">
                                                <div
                                                    className="bg-mindfulgrey text-mindfulWhite w-[40px] h-[40px] rounded-full flex justify-center items-center z-10 cursor-pointer"
                                                >
                                                    1
                                                </div>
                                            </Link>
                                            ...
                                            {/* <Link to="/Cart"> */}
                                            <div
                                                className="bg-mindfulBlue text-mindfulWhite w-[40px] h-[40px] border-2 border-mindfulBlack rounded-full flex justify-center items-center"
                                            >
                                                3
                                            </div>
                                            {/* </Link> */}
